...
plt.xlim(-5,5)  #This function looks best when 
...
while(run):  #Check if the event loop has not been interrupted
    ...
    fractal = fe.fractpoints(coeffs, 100)  #Run the engine to get a figure.
    ...
    plt.pause(.001)  #This pause draws the frame before looping.
